...
if(CUDA_FOUND)
  ...
  # hipistl SOURCE
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/detail/CuBlasHandle.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/detail/cusparse_matrix_operations.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/detail/CuSparseHandle.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/CuVector.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/detail/vector_operations.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/CuSparseMatrix.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/CuDILU.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/CuJac.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/CuSeqILU0.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/set_device.hip)

  # hipistl HEADERS
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cuda_safe_call.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cusparse_matrix_operations.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cusparse_safe_call.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cublas_safe_call.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cuda_check_last_error.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/CuBlasHandle.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/CuSparseHandle.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/CuDILU.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/CuJac.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/CuVector.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/CuSparseMatrix.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/CuMatrixDescription.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/CuSparseResource.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/CuSparseResource_impl.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/safe_conversion.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cublas_wrapper.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cusparse_wrapper.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/cusparse_constants.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/vector_operations.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/has_function.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/preconditioner_should_call_post_pre.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/PreconditionerAdapter.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/CuSeqILU0.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/detail/fix_zero_diagonal.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/PreconditionerConvertFieldTypeAdapter.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/CuOwnerOverlapCopy.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/SolverAdapter.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/CuBlockPreconditioner.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/PreconditionerHolder.hpp)
  list (APPEND PUBLIC_HEADER_FILES opm/simulators/linalg/hipistl/set_device.hpp)
  endif()
