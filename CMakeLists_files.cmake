...
macro (DONTUSEMEDELETEMETEST FILEPATH)
  file(RELATIVE_PATH relpath ${CMAKE_SOURCE_DIR} ${FILEPATH})
  list(APPEND TEST_SOURCE_FILES ${relpath})
endmacro()

macro (DONTUSEMEDELETEMESOURCE FILEPATH)
  file(RELATIVE_PATH relpath ${CMAKE_SOURCE_DIR} ${FILEPATH})
  list(APPEND MAIN_SOURCE_FILES ${relpath})
endmacro()


macro (DONTUSEMEDELETEMEHEADERS FILEPATH)
  file(RELATIVE_PATH relpath ${CMAKE_SOURCE_DIR} ${FILEPATH})
  list(APPEND PUBLIC_HEADER_FILES ${relpath})
endmacro()
...
if(CUDA_FOUND)
  ...
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/CuBlasHandle.cpp)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cusparse_matrix_operations.cu)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/CuSparseHandle.cpp)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuVector.cpp)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/vector_operations.cu)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuSparseMatrix.cpp)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuDILU.cpp)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuJac.cpp)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuSeqILU0.cpp)
  DONTUSEMEDELETEMESOURCE(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/set_device.cpp)

  # hipistl HEADERS
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cuda_safe_call.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cusparse_matrix_operations.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cusparse_safe_call.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cublas_safe_call.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cuda_check_last_error.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/CuBlasHandle.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/CuSparseHandle.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuDILU.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuJac.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuVector.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuSparseMatrix.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/CuMatrixDescription.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/CuSparseResource.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/CuSparseResource_impl.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/safe_conversion.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cublas_wrapper.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cusparse_wrapper.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/cusparse_constants.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/vector_operations.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/has_function.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/preconditioner_should_call_post_pre.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/PreconditionerAdapter.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuSeqILU0.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/detail/fix_zero_diagonal.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/PreconditionerConvertFieldTypeAdapter.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuOwnerOverlapCopy.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/SolverAdapter.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/CuBlockPreconditioner.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/PreconditionerHolder.hpp)
  DONTUSEMEDELETEMEHEADERS(${CMAKE_BINARY_DIR}/opm/simulators/linalg/hipistl/set_device.hpp)
...
if(CUDA_FOUND)
  ...
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_converttofloatadapter.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cublas_handle.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cublas_safe_call.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cusparse_safe_call.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cuda_safe_call.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cuda_check_last_error.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cujac.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cuowneroverlapcopy.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cuseqilu0.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cusparse_handle.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cuSparse_matrix_operations.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cusparsematrix.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cuvector.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_cuVector_operations.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_safe_conversion.cpp)
  DONTUSEMEDELETEMETEST(${CMAKE_BINARY_DIR}/tests/hipistl/test_solver_adapter.cpp)
