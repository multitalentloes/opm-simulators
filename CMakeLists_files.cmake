...
if(CUDA_FOUND)
  # CUISTL SOURCE
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/detail/CuBlasHandle.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/detail/cusparse_matrix_operations.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/detail/CuSparseHandle.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/CuVector.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/detail/vector_operations.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/CuSparseMatrix.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/CuDILU.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/CuJac.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/CuSeqILU0.hip)
  list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/cuistl/set_device.hip)
...
#if(hip_FOUND)
#list (APPEND MAIN_SOURCE_FILES opm/simulators/linalg/hipistl/hip_test.cpp)
#endif()
...
if(CUDA_FOUND)
  ...
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_converttofloatadapter.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cublas_handle.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cublas_safe_call.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cusparse_safe_call.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cuda_safe_call.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cuda_check_last_error.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cujac.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cuowneroverlapcopy.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cuseqilu0.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cusparse_handle.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cuSparse_matrix_operations.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cusparsematrix.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cuvector.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_cuVector_operations.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_safe_conversion.hip)
  list(APPEND TEST_SOURCE_FILES tests/cuistl/test_solver_adapter.hip)
