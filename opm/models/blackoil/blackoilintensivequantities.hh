...
public:
    ...
    explicit BlackOilIntensiveQuantities(
        ...
        , BlackOilDiffusionIntensiveQuantities<TypeTag, enableDiffusion>(other)
    ...
    {
        // Changing diffusion or dispersion support across a TypeTag conversion would
        // silently produce incorrect results (the missing quantities would be left at
        // their default-initialised values). Catch such mismatches at compile time.
        static_assert(getPropValue<OtherTypeTag, Properties::EnableDiffusion>() == enableDiffusion,
                      "Cannot convert BlackOilIntensiveQuantities between TypeTags with "
                      "different EnableDiffusion settings.");
        static_assert(getPropValue<OtherTypeTag, Properties::EnableDispersion>() == enableDispersion,
                      "Cannot convert BlackOilIntensiveQuantities between TypeTags with "
                      "different EnableDispersion settings.");
    }
