...
*/
#ifndef OPM_hipistl_CUBLOCKPRECONDITIONER_HPP
#define OPM_hipistl_CUBLOCKPRECONDITIONER_HPP

#include <dune/common/shared_ptr.hh>
#include <memory>
#include <opm/simulators/linalg/PreconditionerWithUpdate.hpp>
#include <opm/simulators/linalg/hipistl/PreconditionerHolder.hpp>
#include <opm/simulators/linalg/hipistl/detail/preconditioner_should_call_post_pre.hpp>

namespace Opm::hipistl
{
//! @brief Is an adaptation of Dune::BlockPreconditioner that works within the hipistl framework.
//!
