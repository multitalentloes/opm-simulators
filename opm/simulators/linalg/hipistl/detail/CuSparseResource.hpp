 ...
 * Example usage:
 * @code{.cpp}
 * #include <opm/simulator/linalg/hipistl/detail/CuSparseResource.hpp>
 *
 * void someFunction() {
...
} // namespace Opm::hipistl::impl
#include <opm/simulators/linalg/hipistl/detail/CuSparseResource_impl.hpp>
