...
*/
#ifndef OPM_CUDA_CHECK_LAST_ERROR_HPP_HIP
#define OPM_CUDA_CHECK_LAST_ERROR_HPP_HIP
 ...
 * Example usage:
 * @code{.cpp}
 * #include <opm/simulators/linalg/hipistl/detail/cuda_check_last_error.hpp>
 *
 * void some_function() {
