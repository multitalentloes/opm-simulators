...
*/
#ifndef OPM_hipistl_SAFE_CONVERSION_HPP
#define OPM_hipistl_SAFE_CONVERSION_HPP
 ...
 * bits to 32 bits.
 *
 * The main use case within hipistl is that the cusparse library requires signed int for all its size parameters,
