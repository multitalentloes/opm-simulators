...
*/
#ifndef OPM_SOLVERADAPTER_HPP_HIP
#define OPM_SOLVERADAPTER_HPP_HIP
...
#include <opm/simulators/linalg/hipistl/CuOwnerOverlapCopy.hpp>
#include <opm/simulators/linalg/hipistl/CuSparseMatrix.hpp>
#include <opm/simulators/linalg/hipistl/CuVector.hpp>
#include <opm/simulators/linalg/hipistl/PreconditionerAdapter.hpp>
#include <opm/simulators/linalg/hipistl/detail/has_function.hpp>



namespace Opm::hipistl
{
...
public:
    ...
    using XGPU = Opm::hipistl::CuVector<real_type>;
        ...
        if constexpr (detail::has_communication<Operator>::value) {
            ...
            if (!precAsHolder) {
                OPM_THROW(std::invalid_argument,
                          ...
                          "Opm::hipistl::PreconditionerAdapter wrapped in a "
                          "Opm::hipistl::CuBlockPreconditioner. If you are unsure what this means, set "
            ...
            if (!precAsHolder) {
                OPM_THROW(std::invalid_argument,
                          ...
                          "Opm::hipistl::PreconditionerHolder (eg. CuILU0).");
            }
