...
#include <iostream>
  ...
  using GPUPLTwoPhaseLaw = Opm::PiecewiseLinearTwoPhaseMaterial<TraitsT, GPUViewParams>;
  using GPUTwoPhaseLawParams = Opm::EclTwoPhaseMaterialParams<TraitsT, GPUViewParams, GPUViewParams, GPUViewParams, false>;
...
__global__ void gpuTwoPhaseSatPcnwWrapper(GPUPLTwoPhaseLaw::Params params, NorneEvaluation Sw, NorneEvaluation* res){
    *res = GPUPLTwoPhaseLaw::twoPhaseSatPcnw(params, Sw);
}
