...
#include <iostream>
  ...
  using constGPUTwoPhaseBufferMaterialLaw = Opm::PiecewiseLinearTwoPhaseMaterial<TraitsT, constGPUBufferParams>;
...
BOOST_AUTO_TEST_CASE(TestSimpleInterpolation)
{
    ...
    gpuViewParams = Opm::cuistl::make_view<TraitsT, const GPUBuffer, GPUView>(gpuBufferParams);
